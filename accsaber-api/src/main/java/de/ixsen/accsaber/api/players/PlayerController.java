...
public class PlayerController {
    ...
    @Autowired
    public PlayerController(PlayerService playerService, PlayerMapper playerMapper, ScoreMapper scoreMapper, ScoreService scoreService, RankedMapService rankedMapService) {
    ...
    @PostMapping
    public ResponseEntity<?> addNewPlayer(@RequestBody PlayerSignupDto playerSignupDto) {
        String playerId = playerSignupDto.getScoresaberLink();
        ...
        this.playerService.signupPlayer(playerId, playerSignupDto.getPlayerName(), playerSignupDto.getHmd());
    ...
    public ResponseEntity<ArrayList<PlayerScoreDto>> getPlayerScores(@PathVariable String playerId) {
        ...
        ArrayList<PlayerScoreDto> playerScoreDtos = this.scoreMapper.rankedScoresToPlayerScores(scoresForPlayer);
    ...
    public ResponseEntity<ArrayList<PlayerDto>> getPlayers() {
        ...
        ArrayList<PlayerDto> playerDtos = this.playerMapper.playersToPlayerDtos(playerEntities);
